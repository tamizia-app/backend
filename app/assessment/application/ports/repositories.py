...
from app.assessment.domain.metrics import ExerciseScore, SpeakingMetrics, WritingMetrics, AssessmentResult, ManualReviewEvent
...
class AssessmentResultRepository(Protocol):
    ...
    def update(self, r: AssessmentResult) -> AssessmentResult: ...
...
class ManualReviewEventRepository(Protocol):
