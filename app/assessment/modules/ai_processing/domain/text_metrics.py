...
from app.assessment.modules.ai_processing.domain.entities import ReadingMetrics, TextComparison, WritingMetrics
...
def compare_expected_text(reference_text: str, observed_text: str) -> TextComparison:
    omissions, substitutions = omission_and_substitution_counts(reference_text, observed_text)
    return TextComparison(
        cer_score=cer(reference_text, observed_text),
        wer_score=wer(reference_text, observed_text),
        omissions=omissions,
...
def calculate_writing_metrics(reference_text: str, observed_text: str) -> WritingMetrics:
    comparison = compare_expected_text(reference_text, observed_text)
