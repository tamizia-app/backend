...
from app.school.modules.students.application.queries.student_queries import (
    GetStudentQuery,
...
from app.school.modules.students.domain.repositories import StudentRepository
