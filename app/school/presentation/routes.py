...
from app.school.presentation.schemas import HomeroomTeacherResponse, UpdateHomeroomTeacherRequest
...
@router.get("/me", response_model=HomeroomTeacherResponse)
...
@router.put("/me", response_model=HomeroomTeacherResponse)
